          ...
          <div className="grid max-w-sm gap-5 mb-8 lg:grid-cols-3 sm:mx-auto lg:max-w-full">
            ...
            <div className="px-10 py-20 text-center border rounded lg:px-5 lg:py-10 xl:py-20">
              ...
              <p className="max-w-xs mx-auto mb-2 ">
                ...
                whilst the records receives created or edited. Data transmission
                is treated with net sockets so that we do not must ship requests
                to get new records,Each feature works independently, and they
                work even better together. <br />
            ...
            <div className="px-10 py-20 text-center border rounded lg:px-5 lg:py-10 xl:py-20">
              ...
              <p className="max-w-xs mx-auto mb-2 ">
                The react private route component renders a route component if
                the user is logged in and in an authorised role for the route,
                if the user isn’t logged in they’re redirected to the /login
                page, if the user is logged in but aren’t in an authorised role
            ...
            <div className="px-10 py-20 text-center border rounded lg:px-5 lg:py-10 xl:py-20">
              ...
              <p className="max-w-xs mx-auto mb-2 ">
                Node.js is a JavaScript runtime used to create scalable
                server-side and networking applications via virtual private
                servers. It offers non-blocking input/output (I/O) operations
                and is built on event-driven, asynchronous architecture to help
                developers create various projects efficiently and easily.
              </p>
            </div>
          </div>
        </div>
